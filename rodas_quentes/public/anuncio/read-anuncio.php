        ...
        <div class="d-flex">
            <div class="d-flex flex-column m-5">
                <div class="d-flex m-1">
                    <a href="delete-anuncio.php?id=<?php echo $ad['id'] ?>" class="icon"><img src="../../img/delete.png" alt="Delete" style="width: 30px; height: auto; margin-right: 5px;"></a>
                    <a href="update-anuncio.php?id=<?php echo $ad['id'] ?>" class="icon"><img src="../../img/update.png" alt="Update" style="width: 30px; height: auto; margin-left: 5px;"></a>
                </div>
